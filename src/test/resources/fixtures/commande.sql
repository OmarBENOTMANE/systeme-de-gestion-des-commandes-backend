...
VALUES (1, 'consi ','etat navire', 'namenavire', 2,false);
...
INSERT INTO gcmd_commande (id, bulletin_reception, capitaine, connaissement, consignataire,
                           ...
                           numero_credit, navire, numero_bc, numero_escale, poste, is_deleted, devis_id, escale_id, bulltin_prestation_id,isfactured)
VALUES (1, 2, 'capi cmd', 3, 'consi', '2022-04-25', '2022-04-25', 4, 5, 6, 7, 'navire', 8, 9, 'post', false, 1,1, 1,false );
