...
public class CommandeController {
    ...
    @GetMapping("commandesIsfacturedFalse")
    public ResponseEntity<Page<CommandeDTO>> findAllByIsfacturedFalse(Pageable pageable) {
        return ResponseEntity.status(HttpStatus.OK).body(commandeService.findAllByIsfacturedFalse(pageable));
    }
