INSERT INTO gcmd_bulltin_prestation (id, code_client, code_nature, date, date_depot, date_probable_execution,
                                     ...
                                     is_deleted, validated, isfactured, is_sent)
...
insert into gcmd_ligne_commande (id, is_deleted, date, description, genlbp, heure, is_affected, nombre,
                                 designation_prestation, produit, sens_trafic, tarif_unifie, tc_conv, tc_suppl,
                                 tonnage_minimum, tonnage_reel, commande_id, prestation_id, is_selected)
values (1, false, '2022-04-26', 'descri lcmd', 1, '04:00:00', false, 2, 'designationPrestation', 'prod', 'TRANSIT',
        false, false, 'tc_suppl', 4, 3, null, null, true);
